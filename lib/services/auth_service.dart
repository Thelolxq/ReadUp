...
class AuthService {
  ...
  Future<void> register(Map<String, dynamic> registrationData) async {
    ...
    try {
      ...
      throw Exception('Fallo la conexión con el servidor. Inténtalo de nuevo $error.');
    }
  }
  ...
  try {
    ...
    if (response.statusCode == 200) { 
      ...
      try {
        ...
        final errorMessage = errorData['message'] ?? errorData['error'] ?? 'Error desconocido desde la API.';
